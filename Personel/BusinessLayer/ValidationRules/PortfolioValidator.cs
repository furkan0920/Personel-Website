...
namespace BusinessLayer.ValidationRules
{
	public class PortfolioValidator:AbstractValidator<Portfolio>
	{
        public PortfolioValidator()
        {
            ...
            RuleFor(x => x.Name).MinimumLength(5).WithMessage("Proje adı en az 5 karakteden oluşmak zorundadır");
            RuleFor(x => x.Name).MaximumLength(100).WithMessage("Proje adı en fazla 100 karakteden oluşmak zorundadır");
        }
    }
}
